...
export function ModalProvider(_a) {
    ...
    var openModal = useCallback(function (_a) {
        var Modal = _a.Modal, header = _a.header, body = _a.body, _b = _a.overlayClose, overlayClose = _b === void 0 ? false : _b, _c = _a.closeButton, closeButton = _c === void 0 ? false : _c, overlayStyle = _a.overlayStyle, onOk = _a.onOk, onCancel = _a.onCancel;
    ...
    return (_jsxs(ModalContext.Provider, { value: { openModal: openModal }, children: [modals.map(function (_a) {
                var id = _a.id, Modal = _a.Modal, header = _a.header, body = _a.body, overlayClose = _a.overlayClose, closeButton = _a.closeButton, overlayStyle = _a.overlayStyle, onConfirm = _a.onConfirm, onClose = _a.onClose, onCancel = _a.onCancel;
                ...
                return (_jsx(ModalPortal, { children: _jsx("div", __assign({ className: "watery-ui-modal-wrapper", style: __assign({ position: 'fixed', width: '100vw', height: '100vh', top: 0, left: 0, display: 'grid', placeItems: 'center', zIndex: 1001, backgroundColor: 'rgba(255, 255, 255, 0.75)' }, overlayStyle) }, (overlayClose
                        ...
                        : {}), { children: Modal ? (React.cloneElement((_jsx(Modal, {})), {
                            onConfirm: onConfirm,
                            onClose: onClose,
                                        ...
                                        : React.cloneElement(body, {
                                            onConfirm: onConfirm,
                                            onClose: onClose,
                                        }) }), isUseFooter && (_jsxs("div", { className: "p-2 w-full flex justify-center gap-x-1", children: [onConfirm && (_jsx("button", { className: "grow rounded-md text-lg bg-gray-700 text-white hover:bg-gray-800 active:bg-gray-900", onClick: function () { return onConfirm(); }, children: "\uD655\uC778" })), (closeButton || onCancel) && (_jsx("button", { className: "grow rounded-md text-gray-700 hover:bg-gray-100 active:bg-gray-200", onClick: function () { return onClose(); }, children: "\uCDE8\uC18C" }))] }))] })) })) }, id));
            }), children] }));
}
